...
\end{figure}
Students, Companies and Universities are implemented by extending the abstact class User. The User class contains the common attributes: email, password and
