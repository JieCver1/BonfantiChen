...
[A4] Every department of a company has a unique email address that identify it.

[A5] The platform will be able to communicate correctly with email servers to send notifications to users.

[A6] The platform has a secure and functional user authentication system to protect user data.

[A7] Users have a stable internet connection to access the platform.

[A8] Who wants to use the platform must have a device that supports the platform's features.

[A9] The companies publish do not publish the same internship offer more than once before the application deadline.

[A10] The student do not apply for the internship if she/he has already accepted offer which starts in the same period.
