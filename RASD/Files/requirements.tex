...
[R1] S\&C allows visitors to sign up
...
\begin{center}
    \begin{tabular}{|>{\columncolor{bluepoli!40}}c|p{22em}|p{11em}|}
        ...
        \hline
        G1 & R1, R2 & A1, A2, A5, A6, A7, A8 \\
        G2 & R36, R3 & A3, A5, A6, A7, A8 \\
        G3 & R4, R21 & A6, A7, A8 \\
        G4 & R5, R6, R7 & A4, A6, A7, A8, A9 \\
        G5 & R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19 & A5, A6, A7, A8 \\
        G6 & R13, R18, R19 & A3, A5, A6, A7, A8 \\
        G7 & R20, R21 & A3, A6, A7, A8, A10 \\
        G8 & R22, R23, R24 & A4, A6, A7, A8 \\
        G9 & R25 & A6, A7, A8 \\
        G10 & R26, R27 & A4, A6, A7, A8 \\
        G11 & R28 & A4, A5, A6, A7, A8 \\
        G12 & R29, R37 & A6, A7, A8 \\
        G13 & R30, R31, R38, R39 & A6, A7, A8 \\
        G14 & R32 & A6, A7, A8 \\
        G15 & R33, R34 & A6, A7, A8 \\
        \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \textbf{[R1] S\&C allows visitors to sign up}\\
        \rowcolor{bluepoli!15}
        ...
        \textbf{[A5] The platform will be able to communicate correctly with email servers to send notifications to users.}\\
        \textbf{[A6] The platform has a secure and functional user authentication system to protect user data.}\\
        \textbf{[A7] Users have a stable internet connection to access the platform.}\\
        \textbf{[A8] Who wants to use the platform must have a device that supports the platform's features.}\\
        \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \textbf{[A7] Users have a stable internet connection to access the platform.}\\
        \textbf{[A8] Who wants to use the platform must have a device that supports the platform's features.}\\
        \textbf{[A9] The companies publish do not publish the same internship offer more than once before the application deadline.}\\
        \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \textbf{[A7] Users have a stable internet connection to access the platform.}\\
        \textbf{[A8] Who wants to use the platform must have a device that supports the platform's features.}\\
        \textbf{[A10] The student do not apply for the internship if she/he has already accepted offer which starts in the same period.}\\
        \hline
    \end{tabular}
\end{center}
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \rowcolor{bluepoli!15}
        \textbf{[R32] S\&C allows STs and COs to exchange information using the chat, only if the ST is participating or has participated in an internship offered by the company.} \\
        \textbf{[A6] The platform has a secure and functional user authentication system to protect user data.}\\
        \textbf{[A7] Users have a stable internet connection to access the platform.}\\
        \textbf{[A8] Who wants to use the platform must have a device that supports the platform's features.}\\
        \hline
