...
\begin{itemize}
    ...
    side menu will include sections such as Search Internships, Dashboard, My Profile, My Applications and My Internships.
    ...
    parties can provide feedback or companies during the internship, and at the end, to complete the evaluation process, they must leave
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        2. Overview of suggested Student Profiles: Displays student profiles suggested by the platform's matching algorithm for internship 
...
backend processes, such as recommendation algorithm, the data collection and the statistical analyses.
...
[R37] S\&C allows STs to check the status of their applications

[R38] S\&C should notify UNIs when their students register on the platform
...
\begin{center}
    \begin{tabular}{|>{\columncolor{bluepoli!40}}c|p{20em}|p{13em}|}
        ...
        G5  & R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R38 & A6, A7 \\
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \rowcolor{bluepoli!15}
        \textbf{[R38] S\&C should notify UNIs when their students register on the platform.} \\
        % -------------------------------------------------------
        \textbf{[A6] Users have a stable internet connection to access the platform.}\\
        \textbf{[A7] The users of the platform must have a device that supports the platform's features.}\\
        \hline
...
\begin{center}
    \begin{tabular}{|p{37em}|}
        ...
        \rowcolor{bluepoli!15}
        \textbf{[R37] S\&C allows STs to check the status of their applications.} \\
        % -------------------------------------------------------
        \textbf{[A6] Users have a stable internet connection to access the platform.}\\
        \textbf{[A7] The users of the platform must have a device that supports the platform's features.}\\
        \hline
...
\begin{center}
    \begin{tabular}{|p{9em}|p{27em}|}
        ...
        \begin{enumerate}
            ...
            student to take part in an internship) or ignored it.
        \end{enumerate} \\
        \hline
        \textbf{Exit Condition} & 
        The system displayed the recommendation details to the student or company who requested it and
        allowed them to do the desired action. \\
        \hline
        \textbf{Exceptions} & 
        If there are not enough data to provide a recommendation related to the student or company, the system will show a message
...
\begin{longtable}{|c|c|c|}
    \hline
    % Header row
     & \textbf{Req ID} & \textbf{Principal Use Case} \T\B \\
    \hline \hline
    \endfirsthead%
    ...
    % Table body
        \hline \hline
        \textbf{row1} & R1 & U1.Register to S\&C   \T\B \\
        \hline
        \textbf{row2} & R2 & U2.Login to S\&C  \T\B \\
        \hline
        \textbf{row3} & R3 & U5.Upload CV  \T\B \\
        \hline
        \textbf{row4} & R4 & U6.Search internship  \T\B \\
        \hline
        \textbf{row5} & R5 & U14.Create and Publish Internship  \T\B \\
        \hline
        \textbf{row6} & R6 & U14.Create and Publish Internship  \T\B \\
        \hline
        \textbf{row7} & R7 & U14.Create and Publish Internship  \T\B \\
        \hline
        \textbf{row8} & R8 & U15.Select Candidates  \T\B \\
        \hline
        \textbf{row9} & R9 & U4. View recommendation  \T\B \\
        \hline
        \textbf{row10} & R10 & U10.Send interview results  \T\B \\
        \hline
        \textbf{row11} & R11 & U15.Select Candidates  \T\B \\
        \hline
        \textbf{row12} & R12 & U11.Accept/reject offer  \T\B \\
        \hline
        \textbf{row13} & R13 & U4.View recommendation  \T\B \\
        \hline
        \textbf{row14} & R14 & U15.Select Candidates  \T\B \\
        \hline
        \textbf{row15} & R15 & U11.Accept/reject offer  \T\B \\
        \hline
        \textbf{row16} & R16 & U11.Accept/reject offer  \T\B \\
        \hline
        \textbf{row17} & R17 & U13.Chatting  \T\B \\
        \hline
        \textbf{row18} & R18 & U4.View recommendation  \T\B \\
        \hline
        \textbf{row19} & R19 & U4.View recommendation  \T\B \\
        \hline
        \textbf{row20} & R20 & U7.Apply internship  \T\B \\
        \hline
        \textbf{row21} & R21 & U6.Search internship \T\B \\
        \hline
        \textbf{row22} & R22 & U15.Select Candidates  \T\B \\
        \hline
        \textbf{row23} & R23 & U15.Select Candidates  \T\B \\
        \hline
        \textbf{row24} & R24 & U8.Create interview\T\B \\
        \hline
        \textbf{row25} & R25 & U9.Respond to interview questionnaire \T\B \\
        \hline
        \textbf{row26} & R26 & U10.Send interview results  \T\B \\
        \hline
        \textbf{row27} & R27 & U12.Send interview results  \T\B \\
        \hline
        \textbf{row28} & R28 & U13.Chatting  \T\B \\
        \hline
        \textbf{row29} & R29 & U14.Accept/reject offer \T\B \\
        \hline
        \textbf{row30} & R30 & U12.Write feedback and complaints  \T\B \\
        \hline
        \textbf{row31} & R31 & U12.Write feedback and complaints \T\B \\
        \hline
        \textbf{row32} & R32 & U13.Chatting  \T\B \\
        \hline
        \textbf{row33} & R33 & U16.Monitor internship of students  \T\B \\
        \hline
        \textbf{row34} & R34 & U16.Monitor internship of students  \T\B \\
        \hline
        \textbf{row35} & R35 & U3.See profile information  \T\B \\
        \hline
        \textbf{row36} & R36 & U5.Upload CV \T\B \\
        \hline
        \textbf{row37} & R37 & U14.Accept/reject offer  \T\B \\
        \hline
        \textbf{row38} & R38 & U1.Register to S\&C  \T\B \\
        \hline
    \end{longtable}
