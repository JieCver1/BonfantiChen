...
\begin{center}
    \begin{tabular}{|p{9em}|p{27em}|}
        ...
        \begin{enumerate}
            ...
            \item S\&C checks that the student has not already applied for the internship.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Images/Sequence_Diagrams/monitor_SD.png}
