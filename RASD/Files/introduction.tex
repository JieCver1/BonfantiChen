...
\begin{itemize}
    ...
    \item \textbf{Feedback:} Helpful information written by students and companies about their internship experiences to improve a performance of two parties.
    ...
    internships.
    \item \textbf{Keyword:} A label or tag using word of great significance to describe content, such as skills, experiences, and preferences
...
\begin{itemize}
    ...
    \item \textbf{[An]:} Used to number the definitions, where An is the n-th definition.
