...
\begin{table}[h!]
    ...
    \textbf{Version:} & 1.0 \\ 
    \textbf{Date:} & 06-January-2025 \\
    \textbf{Download page:} & https://github.com/JieCver1/BonfantiChen \\
    \textbf{Copyright:} & Copyright © 2025, Riccardo Bonfanti, Jie Chen – All rights reserved \\
    \hline
    \end{tabu}
    \end{table}
